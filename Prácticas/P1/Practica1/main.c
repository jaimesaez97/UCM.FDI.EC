...
unsigned char traspuesta[N*M];

extern void apply_gaussianARM(unsigned char[], unsigned char[], int, int);
extern void rowToColumnARM(unsigned char[], unsigned char[], int, int);
#ifndef LENA
